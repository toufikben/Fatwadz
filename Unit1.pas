...
//  AppDir := 'Fatwa_audio_loction'+'\';
  ...
  begin
  AppDir := 'Fatwa_audio_loction'+'\ferkous'+'\';
  end;
  if cb1.ItemIndex = 1 then
  begin
    AppDir := 'Fatwa_audio_loction'+'\abd_almajid_jomaa'+'\';
  end;
  if cb1.ItemIndex = 2 then
  begin
  AppDir := 'Fatwa_audio_loction'+'\sneeqireh'+'\';
  end;
  path := ExtractFilePath (application.ExeName);
...
dm.FDQuery1.Active := True;
 ...
 if not DirectoryExists(ExtractFilePath (application.ExeName)+'Fatwa_audio_loction'+'\ferkous') then
 begin
 CreateDir(ExtractFilePath (application.ExeName)+'Fatwa_audio_loction'+'\ferkous');
end;

 if not DirectoryExists(ExtractFilePath (application.ExeName)+'Fatwa_audio_loction'+'\abd_almajid_jomaa') then
 begin
 CreateDir(ExtractFilePath (application.ExeName)+'Fatwa_audio_loction'+'\abd_almajid_jomaa');
end;

 if not DirectoryExists(ExtractFilePath (application.ExeName)+'Fatwa_audio_loction'+'\sneeqireh') then
 begin
 CreateDir(ExtractFilePath (application.ExeName)+'Fatwa_audio_loction'+'\sneeqireh');
end;
end;
